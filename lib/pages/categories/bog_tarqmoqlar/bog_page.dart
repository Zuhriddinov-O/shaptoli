    ...
    return Scaffold(
        ...
        body: RefreshIndicator(
          ...
          child: ListView(children: [
             const Padding(padding: EdgeInsets.only(top: 8, left: 12), child: Text("Bog' va tomorqa", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 27))),
             Padding(padding: const EdgeInsets.only(left: 12), child: Text("${filteredList.length} ta tovar", style: const TextStyle(color: Colors.grey, fontSize: 18))),
